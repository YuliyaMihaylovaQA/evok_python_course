#распаковка используется чтобы не обращаться к элементам по индексу
my_list = [1, 3]
my_tuple = (2, 6, 9)
# a = my_list[0]
# b = my_list[1]
...
lll = [1, 3, 5, 2, 5, 7 ,1, 3]
print(lll)
print(lll[1:4]) #распечатает с 1 индекса до 4 (4 индекс не входит)
print(lll[:4])
print(lll[3:])
print(lll[1::2]) #распечатает список с 1 индекса до конца списка с шагом 2
print(lll[:]) # распечатает весь список
print(lll[::-1]) # распечатает весь список с конца
print(lll[::-2]) # распечатает весь список с конца с шагом 2
print(lll[-2:-6:-1]) #распечатает список с конца с  2 до 6 индекса(с конца элементы считаются с 1
